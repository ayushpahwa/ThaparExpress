...
public class Societies extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDrawerLayout = (DrawerLayout) findViewById(R.id.drawer_layout_societies);
        mDrawerList = (ListView) findViewById(R.id.left_drawer_societies);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch(item.getItemId()) {
            case R.id.details:
                i=new Intent(Societies.this,Details.class);
                startActivity(i);
                return true;
            case R.id.Feedback:
                i=new Intent(Societies.this,FeedBack.class);
                startActivity(i);
                return true;
            case R.id.Bug:
                i = new Intent(Societies.this,Bug.class);
                startActivity(i);
                return true;
            default:
